...
/**
 *  Trieda obsahujúca informácie, metódy atď. na ovládanie obrazovky "Ukončenie hry".
 * @author Matej Pazdič
 */
public class ExitController extends AbstractAppState implements ScreenController {
    ...
    public Nifty nifty;
    /**
     * Inštancia obrazovky "Ukončenie hry".
     */
    ...
    /**
     * Metóda na naviazanie ovládania obrazovky "Ukončenie hry".
     * @param nifty - uzol zgrupujúci všetky obrazovky
     * @param screen - Objekt obrazovky "Ukončenie hry"
     */
    ...
    /**
     * Metóda volajúca sa na začiatku zobrazenia obrazovky "Ukončenie hry".
     */
    ...
    /**
     * Metóda volajúca sa na konci zobrazenia obrazovky "Ukončenie hry".
     */
    ...
    /**
     * Metóda pre tlačidlo ukončenie hry.
     */
